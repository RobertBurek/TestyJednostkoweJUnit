...
//        ElectrisityMeter electrisityMeter = new ElectrisityMeter();
        ...
        Assert.assertTrue(electricityMeter.getKwhNoTariff() == 1);
    }
...
//        ElectrisityMeter electrisityMeter = new ElectrisityMeter();
        ...
        Assert.assertTrue(electricityMeter.getKwhNoTariff() == 5);
    }
...
//        ElectrisityMeter electrisityMeter = new ElectrisityMeter();
        ...
        Assert.assertTrue(electricityMeter.getKwhNoTariff() == 14);
    }
...
//        ElectrisityMeter electrisityMeter = new ElectrisityMeter();
        ...
        Assert.assertTrue(electricityMeter.getKwhNoTariff() == 78);
    }
...
//        ElectrisityMeter electrisityMeter = new ElectrisityMeter();
        electricityMeter.addKwh(5);
        electricityMeter.addKwh(4);
        Assert.assertTrue(electricityMeter.getKwhNoTariff() == 9);
    }
...
//        ElectrisityMeter electrisityMeter = new ElectrisityMeter();
        electricityMeter.addKwh(5);
        Assert.assertTrue("Celowo zrobiono błąd w Assercie.",electricityMeter.getKwhNoTariff() == 7);
